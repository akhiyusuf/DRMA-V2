...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen pt-24 md:pt-32 pb-16 md:pb-24 container mx-auto px-6 max-w-3xl">
      ...
      <h1 className="text-4xl font-heading font-light mb-8 md:text-5xl lg:text-6xl tracking-tight">Privacy <span className="italic text-foreground/60">Policy.</span></h1>
